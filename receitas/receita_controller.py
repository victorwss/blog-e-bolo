...
from model.receita_model import Receita, ReceitaSemId, ReceitaVazia, ReceitaNaoEncontrada
from model.receita_dao_mem import BancoDeDadosReceita

app = Flask(__name__)

db = BancoDeDadosReceita()
